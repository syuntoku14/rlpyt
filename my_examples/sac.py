...
def build_and_train(env_id="LunarLandarContinuous-v2", run_ID=0, cuda_idx=None, sample_mode="serial", n_parallel=2, snapshot_pth=None):
    ...
    if snapshot_pth is not None:
        ...
        # might be useful for logging / debugging
    ...
    # Run with defaults.
    algo = SAC(initial_optim_state_dict=optimizer_state_dict)
