...
def build_and_train(env_id="LunarLandarContinuous-v2", run_ID=0, cuda_idx=None, sample_mode="serial", n_parallel=3, snapshot_pth=None):
    ...
    if snapshot_pth is not None:
        ...
        q2_state_dict = agent_state_dict["q2_model"]
        optimizer_state_dict = data['optimizer_state_dict']
    algo = TD3(initial_optim_state_dict=optimizer_state_dict)  # Run with defaults.
    agent = Td3Agent(initial_q2_model_state_dict=q2_state_dict, initial_q_model_state_dict=q_state_dict,
